...
import 'package:buga_logistics/views/verify_mail.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:  Text('Verify Your Email', style: CustomTextStyle.kBoldTextStyle,),
      ),
        body: Column(
          ...
          children: [
            Container(
              ...
              child: Text('We have sent you a mail. Please click on the link '
            ...
            InkWell(
              ...
              child: CustomButton(
                text: 'Check Your Mail',style: CustomTextStyle.kButtonTextStyle,
              ),
            ),
            Container(
              //padding: EdgeInsets.fromLTRB(left, top, right, bottom),
              ...
              child: RichText(
                  text: TextSpan(
                    children: [
                      TextSpan(text: 'Didn’t receive the mail? ', style: CustomTextStyle.kEmailTextStyle),
                      TextSpan(text: 'Check your spam folder.', style: CustomTextStyle.kTextDescription)
                    ]
                  ) ),
            )
          ],
