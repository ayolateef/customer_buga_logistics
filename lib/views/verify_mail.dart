    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            IconButton(
                onPressed: () {  },
            icon: SvgPicture.asset(AppAsset.smsIcon)
            ),
            IconButton(icon: SvgPicture.asset(AppAsset.trashIcon), onPressed: () {  },),
            IconButton(icon: SvgPicture.asset(AppAsset.smsTrackingIcon), onPressed: () {  },),
            IconButton(icon: SvgPicture.asset(AppAsset.moreIcon), onPressed: () {  },),
          ],
        ),
        body: SingleChildScrollView(
          child: Column(
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    RichText(text: TextSpan(
                      children: [
                        TextSpan(
                          text: 'Verify Your Account ', style: CustomTextStyle.kBoldTextStyle
                        ),
                        TextSpan(
                          text: 'inbox', style: CustomTextStyle.kVerySmallTextStyle
                        )
                      ]
                    )),
              ...
              Container(
                ...
                child: Row(
                       ...
                       RichText( text: TextSpan(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text('to me', style: CustomTextStyle.kVerySmallTextStyle,),
                  ...
                  Spacer(),
                    Row(
                      children: [
                        IconButton(onPressed: (){}, icon: SvgPicture.asset(AppAsset.arrowLeftIcon)),
                        IconButton(onPressed: (){}, icon: SvgPicture.asset(AppAsset.moreIcon))
                      ],
                    ),
                ...
                child: Container(
                  ...
                  Padding(
                    ...
                    child: RichText(
                      ...
                      text:  TextSpan(
                        children: [
                          TextSpan(text: 'Hi Caramel,\n                                                      '
                               ,     style: CustomTextStyle.kTextStyle),

                          TextSpan(text: 'Welcome to BUGA Logistics.\n                                                              '

                              'Help us secure your account by verifying'
                              ' that ', style: CustomTextStyle.kTextStyle),
                             TextSpan(text:'caramelcoker@hotmail.com ', style: CustomTextStyle.kTextStyle2 ) ,
                             TextSpan(text: 'is your email address. \n                                                            '
                             ...
                             'Thank you for choosing BUGA.', style: CustomTextStyle.kTextStyle),
                        ]
                      ),
                    ),
                  ),
              ...
              InkWell(
                onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (context) => AccountVerified())),
                child: Row(
